...
async def start(event):
  await event.reply("**Etiketleme Botu**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilir ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/UtagerproBot?startgroup=a'),
                      Button.url('�Müzik Botu', 'https://t.me/Esmermusic_bot'),
                      Button.url('👮‍♂️ Sahibim', 'https://t.me/benmemotanistirim')]
                    ),
                    link_preview=False
                   )
