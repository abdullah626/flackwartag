...
async def start(event):
  await event.reply("**Etiketleme Botu**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilir ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/Usertagtrbot?startgroup=a'),
                      Button.url('Sohbet Grubumuz', 'https://t.me/sohbetimarane'),
                      Button.url('👮‍♂️ Sahibim', 'https://t.me/serkansimsekkk')]
                    ),
                    link_preview=False
                   )
...
async def help(event):
  ...
  await event.reply(helptext,
                    buttons=(
                      [Button.url('🌟 Beni Bir Gruba Ekle', 'https://t.me/Usertagtrbot?startgroup=a'),
                       Button.url('📣 Support', 'https://t.me/usertgtr'),
                      Button.url('👮‍♂️ Sahibim', 'https://t.me/serkansimsekkk')]
                    ),
                    link_preview=False
                   )
...
@client.on(events.NewMessage(pattern="^/adminall ?(.*)"))
